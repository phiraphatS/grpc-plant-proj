...
let PlantService = (() => {
    ...
    let _classThis;
    var PlantService = _classThis = class {
        constructor(dataSource, plantRepository) {
        ...
        async plantATree(userId, details) {
            ...
            try {
                ...
                // next level is 12 hours from now
                const nextEvent = new Date();
                let next12Hours = nextEvent.getHours() + 12;
                if (next12Hours > 24) {
                    next12Hours = next12Hours - 24;
                    nextEvent.setDate(nextEvent.getDate() + 1);
                }
                nextEvent.setHours(next12Hours);
                // const
    ...
    __setFunctionName(_classThis, "PlantService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PlantService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PlantService = _classThis;
})();
