...
let MastAction = (() => {
    ...
    var MastAction = _classThis = class {
        constructor() {
            this.id = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _id_initializers, void 0));
            this.mood = __runInitializers(this, _mood_initializers, void 0);
    ...
    __setFunctionName(_classThis, "MastAction");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)({ name: "ID" })];
        _mood_decorators = [(0, typeorm_1.Column)("varchar", { name: "MOOD", length: 255 })];
        ...
        __esDecorate(null, null, _mood_decorators, { kind: "field", name: "mood", static: false, private: false, access: { has: obj => "mood" in obj, get: obj => obj.mood, set: (obj, value) => { obj.mood = value; } }, metadata: _metadata }, _mood_initializers, _instanceExtraInitializers);
        ...
        MastAction = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MastAction = _classThis;
})();
exports.MastAction = MastAction;
